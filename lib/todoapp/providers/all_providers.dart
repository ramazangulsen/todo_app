...
import 'package:todo_app/todoapp/providers/todo_list_manager.dart';
...
final currentTodoProvider = Provider<TodoModel>((ref) {
  throw UnimplementedError(); // widget tree ye sağlanacak değeri bilmiyoruz. todo app da provider scope ile sarmaladığımız yerde var olan providerin değerini override edebiliyoruz.
});
